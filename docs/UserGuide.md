...
| Parameter        | Constraints                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
|------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Name**         | Only contain alphanumeric characters, spaces, and cannot be blank                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| **Phone Number** | Only contains digits with a minimum length of 1 (spaces between numbers will be removed)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| **Email**        | Should follow `local-part@domain`. Each segment adheres to the following constraints: <br><br> **Local-Part:** <ul><li>**Allowed Characters:** The local-part can contain alphanumeric characters (letters and numbers) and these special characters: `+`, `_`, `.`, `-`.</li><li>**Restrictions:** The local-part cannot begin or end with any of the special characters (`+`, `_`, `.`, `-`).</li></ul> **Domain:** <ul><li>The domain follows the `@` symbol and consists of domain labels separated by periods (`.`).</li><li>**Domain Label Constraints:** <ul><li>**Ending Label Length:** The final domain label must be at least 2 characters long.</li><li>**Character Use:** Each domain label must start and end with alphanumeric characters.</li><li>**Internal Characters:** Within a domain label, only hyphens (`-`) are allowed to separate alphanumeric characters.</li></ul></li></ul> |
| **Address**      | Any text is allowed                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| **Note**         | Any text is allowed                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| **Tag**          | Only contains alphanumeric characters, with no spaces and cannot be blank                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| **Weight (kg)**  | <li> Must be a positive number (`w/0` will be treated as `w/`) <br> <li>For `weight`, a reasonable maximum value of 5000 is allowed. <li> Although some decimal values of 5000 are allowed (e.g. 5000.000001), the weight and height values will still rounded off to the nearest 1 decimal place (i.e. 5000.0).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| **Height (cm)**  | <li> Must be a positive number (`h/0` will be treated as `h/`) <br> <li>For `height`, a reasonable maximum value of 5000 is allowed. <li> Although some decimal values of 5000 are allowed (e.g. 5000.000001), the weight and height values will still rounded off to the nearest 1 decimal place (i.e. 5000.0).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
