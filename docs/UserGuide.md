...
| [**find**](#finding-clients--find)                                | `find [n/NAME] [p/PHONE_NUMBER] [e/EMAIL] [a/ADDRESS] [nt/NOTE] [t/TAG]…​ [h/MIN_HEIGHT,MAX_HEIGHT] [w/MIN_WEIGHT,MAX_WEIGHT]`<br><br>e.g. `find n/Alex w/40,80 nt/Wants to build muscle t/family`                                     |
